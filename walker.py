...
gym_disc_env = "CartPole-v1"  # "BipedalWalker-v3"  # "CartPole-v1"  #
gym_cont_env = (
    "BipedalWalker-v3"  # "BipedalWalker-v3"  # "Pendulum-v1"  # "HalfCheetah-v4"
)
...
if __name__ == "__main__":
    ...
    if gym_disc_env == "BipedalWalker-v3":
        discrete_env = gym.make(
            gym_disc_env, hardcore=False, render_mode="human"
    ...
    if gym_cont_env == "BipedalWalker-v3":
        continuous_env = gym.make(gym_cont_env, hardcore=True, render_mode="human")
    else:
